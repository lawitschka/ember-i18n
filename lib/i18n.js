(function(window) {
  ...
  I18n = Ember.Evented.apply(Ember.Object.create({
    ...
    TranslateableAttributes: Em.Mixin.create({
      didInsertElement: function() {
        // Add binding to redraw this view when translations change
        var view = this.get('_parentView');
        view.registerObserver(this, 'Ember.I18n.translations', this, this.rerender);
  ...
  Handlebars.registerHelper('t', function(key, options) {
    ...
    // Automatically add binding for value to translations
    attrs['tBinding'] = "Ember.I18n.translations"
